    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { name: "Starter", price: "Free", desc: "For individual projects", features: ["1 active project", "Up to 5 phases", "Basic evidence upload", "Email support", "Mobile access"], cta: "Get Started Free", popular: false },
            { name: "Professional", price: "₦25,000", period: "/month", desc: "For active contractors and owners", features: ["10 active projects", "Unlimited phases", "Advanced analytics", "Priority support", "Quote comparison", "Dispute tracking"], cta: "Start Free Trial", popular: true },
            ...
            <div key={i} className={`relative p-7 rounded-2xl border bg-white dark:bg-slate-900 transition-all ${plan.popular ? "border-slate-900 dark:border-slate-100 shadow-xl shadow-slate-200/50 ring-1 ring-slate-900 dark:ring-slate-100" : "border-slate-200 dark:border-slate-700 hover:shadow-lg"}`}>
              ...
              <Link href="/signup" className={`block w-full text-center py-3 text-sm font-semibold rounded-xl transition-all ${plan.popular ? "bg-slate-900 text-white hover:bg-slate-800 shadow-sm" : "bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700"}`}>{plan.cta}</Link>
            </div>
          ))}
        </div>
        <div className="mt-16 text-center">
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            {[
              ...
              { q: "What payment methods do you accept?", a: "We accept bank transfers, debit cards, and Paystack payments in Naira." },
